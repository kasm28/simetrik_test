# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 23:15:51 2020
...
items.track(name,id,duration_ms,popularity,uri,genre)
...
items(added_at,added_by.id,track(name),album(name),artists(name),duration_ms,explicit,id,name,popularity,track_number,type,uri)

items.track.album(!external_urls,images)
